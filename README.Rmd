...
## About
_This repository contains the development version of __bbsAssistant__. Please submit [Issues here](https://github.com/TrashBirdEcology/bbsAssistant/issues). 
...
```{r hidden, echo=FALSE, warning=FALSE, message=FALSE, eval=FALSE}
# used for building the README locally and troubleshooting
devtools::load_all()
```
...
```{r specs, echo=TRUE, warning=FALSE, message=FALSE, eval=FALSE}
...
bbs <- bbsAssistant::grab_bbs_data(sb_dir=NULL)
```
...
```{r cite, echo=FALSE, eval=TRUE, message=FALSE, warning=FALSE}
...
```{r cite.local, echo=FALSE, eval=TRUE, message=FALSE, warning=FALSE}
