...
For function descriptions please build the manual (`devtools::build_manual()`) and for an example build the vignette (`devtools::build_vignettes()`; or run `/vignettes/vignettes.Rmd`).
