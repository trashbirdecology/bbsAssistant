...
datasets %>% select(-legacy_format, -sb_parent) %>%  
  ...
  kable(caption="List of datasets currently available for download at USGS ScienceBase. Highlighted and bolded row indicates the default BBS observations dataset stored internally in the package.") %>% 
