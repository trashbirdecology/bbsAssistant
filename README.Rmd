...
Use the same code as above to import all the BBS data:
...
cred <- get_analysis_results(analysis = "trend.ests") # default here is to obtain the 1966-2015 species trend estimates
