...
This package contains functions for downloading, importing, and munging the official releases of the [North American Breeding Bird Survey](https://www.pwrc.usgs.gov/bbs/) (BBS) data [(retrieved from  USGS ScienceBase repository)](https://www.sciencebase.gov/catalog). 
