...
Next, enable the drop-down **Survey Results**, and choose **Trend Estimates (by region)** and choose the desired region (e.g. Florida). 
```{r , echo=FALSE, out.width="50%"}
knitr::include_graphics("man/figures/regcred_select_trendests_byregion.png")
```

Finally, copy the URL address for the page including the results and credibility measures (e.g. Florida):

```{r , echo=FALSE, out.width="50%"}
knitr::include_graphics("man/figures/regcred_select_fl.png")
```
