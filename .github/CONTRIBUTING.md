# Contributing
<!--This document was borrowed and slightly edited from r-lib/pkgdown file contributing.md -->
...
bug, create an associated issue and illustrate the bug with a minimal reprex.

## Code of Conduct

Please note that bbsAssistant is released with a
