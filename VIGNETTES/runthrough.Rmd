...
Another huge component of this package is the ability to retrieve data credibility and species trend estimates from the BBS results using the function `get_credibility_trends`.

As an example, we will retrieve the credibility scores and species trend estimates for **House Sparrows in Florida**. 
...
Next, enable the drop-down **Survey Results**, and choose **Trend Estimates (by region)**:
![](/images/regcred_select_trendests_byregion.png)

Next, choose the desired region:
![](/images/regcred_select_fl.png)

Then, copy the URL address when you see a page like this:
Next, choose the desired region:
![](/images/regcred_fl_ex.png)
