...
#' @description Downloads all species-regions annual abundances indices from various .csv files on the BBS analysis results page. See [results metadata](https://www.mbr-pwrc.usgs.gov/bbs/BBSAnalysis_Results_Metadata_1966_2017_v3.xml) for analysis results and trend estimates. 
