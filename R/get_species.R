...
#' 
#' 
#' @description This function is called in the function `bbsAssistant::get_bbs_data()` to append the AOU and NACC species lists to the BBS observations. 
...
get_species <- function(sb_id = NULL,
    ...
    # 
    # if(is.null(dir) & !is.null(sb_dir))  dir <-  paste0(sb_dir,"/data-raw")
    # if(is.null(dir) & is.null(sb_dir))   dir <-  paste0(sb_dir,"/data-raw")
