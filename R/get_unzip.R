#' @title Downloads and unzips a zip archive to file from the USGS BBS FTP server
...
#'   Filename and return as a dataframe. Otherwise, unzip the file specified by ZipName and import into R as a data.frame.
#' @return A dataframe
#' @export get_unzip
