...
## A: Retrieving, Downloading, and Manipulating route-level BBS data
...
download_bbs(country.names="USA", data.dir = bbsDir)
```
...
```{r import_bbs}
bbs.df <- import_bbs(data.dir = here::here("/raw-data/"),state.names=c("FlOrIda", "NEBRASKa")) # capitalization irrevlevant.
(bbs.df$State)
```
...
### Downloading route-level point count data
