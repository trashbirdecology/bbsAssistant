...
### by AOU number
Subset the data by species AOU # (e.g., House Sparrow aou = 06882)
...
You can also merge the BBS county data with the species list to avoid having to refer to AOU, then just subset using species name (e.g. 'House Sparrow'). Note, however, that this is is computationallity expensive when subsetting the entire BBS data set. 
