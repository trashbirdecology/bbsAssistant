...
```{r setup}
## I recommend using force=TRUE, but do not here for build purposes. 
devtools::install_github("trashbirdecology/bbsAssistant", "main", force=FALSE)
...
```{r get_data}
data(bbs_data) # get the most recent data package for bbs
